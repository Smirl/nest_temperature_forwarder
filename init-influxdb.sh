...
# ----- CUSTOM PART -----
INFLUXDB_ADMIN_PASSWORD="$(cat /run/secrets/influxdb_admin_password 2>/dev/null || echo admin)"
INFLUXDB_READ_USER_PASSWORD="$(cat /run/secrets/influxdb_read_user_password 2>/dev/null || echo reader)"
